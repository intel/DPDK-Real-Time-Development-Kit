...
void mqtt_delta(uint64_t delta __rte_unused) { }
...
#define MQTT_M2_TOPIC            "rtdk-data"
#define MQTT_MEASURE_NAME_DELTAS "rtdk-deltas"
#define MQTT_MEASURE_NAME_STATS  "rtdk-stats"
