...
Note: DPDK applications require root privileges to access hardware resources and proper library paths to use the locally-built DPDK.
...
To get BPF to build you may need to install if getting gnu/stubs-32.h not found::
